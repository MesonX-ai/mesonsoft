...
# ============ CSS ANIMATIONS ============
CSS = """
/* ===== Animated icon-list icons (Mesonsoft product pages) ===== */
...
/* Float animation - purple items */
.aux-icon-list-item.beea072 .aux-icon-list-icon.ms-icon {
    color: #9F66FF;
    animation: ms-icon-float 3.2s ease-in-out infinite;
}

/* Float animation - pink items (staggered) */
.aux-icon-list-item.79db1fb .aux-icon-list-icon.ms-icon {
    color: #FF196E;
    animation: ms-icon-float 3.6s ease-in-out infinite;
}
...
.aux-icon-list-item.beea072:hover .aux-icon-list-icon.ms-icon {
    color: #9F66FF;
    filter: drop-shadow(0 4px 8px rgba(159, 102, 255, 0.4));
}
.aux-icon-list-item.79db1fb:hover .aux-icon-list-icon.ms-icon {
    color: #FF196E;
    filter: drop-shadow(0 4px 8px rgba(255, 25, 110, 0.4));
}

/* Pulse glow on hover */
.aux-icon-list-item:hover .aux-icon-list-icon.ms-icon {
    animation: ms-icon-pop 0.4s ease-out;
}
